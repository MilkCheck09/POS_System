  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy;POS System<a href=>Sakda003</a>.</strong> All rights
    reserved.
  </footer>
...
<script>
  Swal.fire({
    ...
    if (result.isConfirmed) {
      // เมื่อผู้ใช้กด "ตกลง" ให้เปลี่ยนเส้นทางไปยัง list_mem.php
      window.location.href = 'list_mem.php';
    }
  });
</script>
<?php } ?>
...
<script>
  ...
  confirmButtonText: 'ตกลง'
    ...
    if (result.isConfirmed) {
      // เมื่อผู้ใช้กด "ตกลง" ให้เปลี่ยนเส้นทางไปยัง list_product.php
